<?php
    ...
    $hinhAnhThiCong = $cache->get("select photo, slugvi, name$lang from #_product where type = ? and find_in_set('hienthi',status) order by numb asc", array('thu-vien-anh'), 'result', 7200);
